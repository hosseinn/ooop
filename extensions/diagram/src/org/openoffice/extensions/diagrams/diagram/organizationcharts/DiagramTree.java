...
public abstract class DiagramTree {
    ...
    protected TreeItem              m_RootItem          = null;
    protected TreeItem              m_SelectedItem      = null;


    public DiagramTree(OrganizationChart orgChart){
        m_OrgChart      = orgChart;
    ...
    public abstract XShape getFirstSiblingShape(XShape xBaseShape, TreeItem dad);
    ...
    public int getShapeID(XShape xShape){
        return getOrgChart().getController().getNumberOfShape(getOrgChart().getShapeName(xShape));
    }
