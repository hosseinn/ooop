 ...
 *  $Revision: 1.1.2.2 $
 *
 *  last change: $Author: kohei $ $Date: 2007/06/14 21:39:11 $
 *
...
class WebQueryBuffer : public GlobalDataHelper
{
public:
    explicit            WebQueryBuffer( const GlobalDataHelper& rGlobalData );
