 ...
 *  $Revision: 1.1.2.3 $
 *
 *  last change: $Author: dr $ $Date: 2007/04/03 14:00:21 $
 *
...
BiffDecoderBase::BiffDecoderBase( const GlobalDataHelper& rGlobalData ) :
...
BiffDecoder_XOR::BiffDecoder_XOR( const GlobalDataHelper& rGlobalData, sal_uInt16 nKey, sal_uInt16 nHash ) :
    BiffDecoderBase( rGlobalData ),
    maCodec( ::oox::core::BinaryCodec_XOR::CODEC_EXCEL )
{
    ...
    if( !isValid() )
    {
        ...
        OString aPass = OUStringToOString( queryPassword(), RTL_TEXTENCODING_MS_1252 );
...
BiffDecoder_RCF::BiffDecoder_RCF( const GlobalDataHelper& rGlobalData,
