...
class HeaderFooterParserImpl : public GlobalDataHelper
{
public:
    explicit            HeaderFooterParserImpl( const GlobalDataHelper& rGlobalData );
...
HeaderFooterParserImpl::HeaderFooterParserImpl( const GlobalDataHelper& rGlobalData ) :
...
void HeaderFooterParserImpl::setAttributes()
{
    ...
    {
        Font aFont( getGlobalData(), maFontData );
...
void HeaderFooterParserImpl::convertFontColor( const OUString& rColor )
{
    ...
    if( (rColor[ 2 ] == '+') || (rColor[ 2 ] == '-') )
        ...
        maFontData.maColor.set(
            OoxColor::TYPE_THEME, rColor.copy( 0, 2 ).toInt32(),
            static_cast< double >( rColor.copy( 2 ).toInt32() ) / 100.0 );
    else
        // RGB color: RRGGBB
        maFontData.maColor.set( OoxColor::TYPE_RGB, rColor.toInt32( 16 ) );
}
...
HeaderFooterParser::HeaderFooterParser( const GlobalDataHelper& rGlobalData ) :
    GlobalDataHelper( rGlobalData ),
    mxImpl( new HeaderFooterParserImpl( rGlobalData ) )
{
}
