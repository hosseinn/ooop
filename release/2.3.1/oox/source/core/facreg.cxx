 ...
 *  $Revision: 1.1.2.6 $
 *
 *  last change: $Author: dr $ $Date: 2007/08/09 11:10:34 $
 *
...
namespace oox {
    ...
    namespace xls { SERVICE( BiffFormatDetector ); }
...
OOX_DLLPUBLIC sal_Bool SAL_CALL component_writeInfo( void * , void * pRegistryKey )
{
	if( pRegistryKey )
	{
		try
		{
            ...
            WRITEINFO( ::oox::xls::BiffFormatDetector );
...
OOX_DLLPUBLIC void * SAL_CALL component_getFactory( const sal_Char * pImplName, void * pServiceManager, void * )
{
	...
	if( pServiceManager )
	{
        ...
        else SINGLEFACTORY( ::oox::xls::BiffFormatDetector )
