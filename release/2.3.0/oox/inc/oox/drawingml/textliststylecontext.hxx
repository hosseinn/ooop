...
{
public:
	TextListStyleContext( const ::oox::core::FragmentHandlerRef& xHandler, oox::drawingml::TextListStylePtr pTextListStylePtr );
...
protected:
	::oox::drawingml::TextListStylePtr mpTextListStylePtr;
};
