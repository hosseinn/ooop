...
for file in *.jpg
do
8echo [+] Creating layout from $file...
mkdir -p ./work/$file
...
cp $file ./work/$file/Pictures/$picturename.jpg
...
sed "s/1000000000000640000004B02C5236E4.png/$picturename.jpg/g" new_styles.xml > styles.xml
#sed "s/10000000000000400000004077CDC8F9.png/$picturename.jpg/g" styles.xml  > new_styles.xml
rm new_styles.xml
echo [.] Change manifest...
sed "s/1000000000000640000004B02C5236E4.png/$picturename.jpg/g" ./META-INF/manifest.xml > ./META-INF/new_manifest.xml
