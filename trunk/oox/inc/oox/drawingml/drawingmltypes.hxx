 ...
 *  $Revision: 1.1.2.13 $
 *
 *  last change: $Author: hub $ $Date: 2007/07/05 15:18:38 $
 *
...
{
public:
	Transform2DContext( const ::oox::core::FragmentHandlerRef& xHandler, const ::com::sun::star::uno::Reference< ::com::sun::star::xml::sax::XFastAttributeList >& xAttributes, ::oox::drawingml::ShapePtr pShapePtr ) throw();
