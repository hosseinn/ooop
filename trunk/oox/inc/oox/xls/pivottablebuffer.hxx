 ...
 *  $Revision: 1.1.2.5 $
 *
 *  last change: $Author: kohei $ $Date: 2007/07/11 13:31:30 $
 *
...
class PivotTableBuffer : public GlobalDataHelper
{
public:
    explicit            PivotTableBuffer( const GlobalDataHelper& rGlobalData );
