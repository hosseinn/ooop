 ...
 *  $Revision: 1.1.2.5 $
 *
 *  last change: $Author: dr $ $Date: 2007/05/29 16:38:37 $
 *
...
class ThemeBuffer : public GlobalDataHelper
{
public:
    explicit            ThemeBuffer( const GlobalDataHelper& rGlobalData );
    virtual             ~ThemeBuffer();

    /** Returns the core drawingml theme needed by the theme fragment importer. */
    ::oox::drawingml::ThemePtr getCoreTheme() const;
