 ...
 *  $Revision: 1.1.2.1 $
 *
 *  last change: $Author: dr $ $Date: 2007/08/14 13:35:17 $
 *
...
#ifndef OOX_CORE_PROPERTYSEQUENCE_HXX
#define OOX_CORE_PROPERTYSEQUENCE_HXX
...
public:
    ...
    explicit            PropertySequence( const sal_Char* const* ppcPropNames );
